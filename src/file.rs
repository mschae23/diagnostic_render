...
//! system directly (and caches the line start locations).
//!
//! [`Files`]: Files
...
pub trait Files {
    ...
    /// function that is exported from the [`file`] module. It might be useful
    ...
    /// function that is exported from the [`file`] module.
    ///
    /// [`file`]: crate::file
...
/// let source = "\n\n🗻∈🌏\n\n";
///
/// assert_eq!(file::column_index(source, 0..1, 0), 0);
/// assert_eq!(file::column_index(source, 2..13, 0), 0);
/// assert_eq!(file::column_index(source, 2..13, 2 + 0), 0);
/// assert_eq!(file::column_index(source, 2..13, 2 + 1), 0);
/// assert_eq!(file::column_index(source, 2..13, 2 + 4), 1);
/// assert_eq!(file::column_index(source, 2..13, 2 + 8), 2);
/// assert_eq!(file::column_index(source, 2..13, 2 + 10), 2);
/// assert_eq!(file::column_index(source, 2..13, 2 + 11), 3);
/// assert_eq!(file::column_index(source, 2..13, 2 + 12), 3);
/// ```
